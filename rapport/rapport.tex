...
Comme le montre la Figure \ref{fig:mcd_v1}, notre modélisation initiale de l'entité \texttt{Formules} était incomplète. Elle était reliée au restaurant (\textit{offrir}) et à la commande (\textit{contenir}), mais elle manquait de définition structurelle.
