...
<body>
    ...
    <div class="container">
            ...
            <?php if ($est_connecte): ?>
                <div>
                    ...
                    <?php if (isset($_SESSION['is_guest']) && $_SESSION['is_guest']): ?>
                        <span
                            style="background-color: #f39c12; color: white; padding: 2px 8px; border-radius: 4px; font-size: 0.8em; margin-left: 5px;">Mode
                            Invité</span>
                    <?php endif; ?>
                </div>
                <div class="header-actions">
                    ...
                    <?php if (isset($_SESSION['is_admin']) && $_SESSION['is_admin'] === true): ?>
                        <a href="statistiques.php"
                            style="background:#2c3e50; color:white; padding:8px 12px; border-radius:6px;">📊 Statistiques</a>
                    <?php endif; ?>
            ...
            <?php else: ?>
                <div class="header-actions">
                    <a href="login_invite.php"
                        style="background-color: #27ae60; color: white; padding: 8px 12px; border-radius: 6px;">👤
                        Invité</a>
                    <a href="login.php">Se connecter</a>
                    <a href="create_account.php"
                        style="background:var(--primary-color); color:white; padding:8px 15px; border-radius:8px; text-decoration:none;">Créer
                        un compte</a>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="filtres-wrapper">
            <a href="index.php" class="btn-filtre <?= ($current_cat === null && $lat === null) ? 'actif' : '' ?>">Tout
                voir</a>
        ...
        <div class="modal-content">
            ...
            <form action="ajout_avis.php" method="POST">
                ...
                <div style="margin-bottom:15px;">
                    ...
                    <textarea name="contenu" rows="4" style="width:100%; padding:8px;"
                        placeholder="C'était délicieux..." required></textarea>
                </div>
                <button type="submit"
                    style="width:100%; padding:10px; background:#27ae60; color:white; border:none; border-radius:5px; cursor:pointer;">Publier
                    l'avis</button>
            </form>
        </div>
    </div>
